// define iife function for this
// name's of all the function are good as it work.
(function(){
    ...
    // if no matching element is found, it returns null. The querySelector () method is the method of the Document interface only. 
    // A document interface is an interface that describes the common methods as well as the properties for any html, XML, or any other kind of document.
    ...
    // This function is for clossing the app by symbol cross
    function closeApp(){
    ...
    // In this function, folder should be added 
    function addFolder(){
        let rname = prompt("Enter folder's name");

        // checking for the input from prompt
        if(rname != null){
            rname = rname.trim();
        }
    ...
    // This function will add text file
    function addTextFile(){
        let rname = prompt("Enter text file's name");
        // checking for the input from the prompt
        if(rname != null){
            rname = rname.trim();
        }
    ...
    // this function if for adding an album.
    function addAlbum(){
    ...
    // this function is for delete any folder
    ...
    // this helper function is for selecting the true value which will be deleted.
    ...
    // this function is for delete any text-file
    function deleteTextFile(){
        let spanDelete = this;
        let divTextFile = spanDelete.parentNode;
        let divName = divTextFile.querySelector("[purpose='name']");

        // The getAttribute() method is used to get the value of an attribute of the particular element. 
        // If the attribute exists, it returns the string representing the value of the corresponding attribute. If the corresponding attribute does not exist, it will return an empty string or null.
        ...
        // from html
        // removeChild () method is used for removing a child element of a node.
    ...
    // this function is for delete an album.
    ...
    // empty, old, unique
    // we need some time to rename any file's or folder's name.
    ...
    // view function is used to view the album,folder and notepad.
    function viewAlbum(){
        let spanView = this;
    ...
    // Creating all function which are for the app menu.
